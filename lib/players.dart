...
class PlayerPageState extends State {
  void deleteDialog(BuildContext context, String id) {
    var alert = AlertDialog(
      ...
      content: const Text("If you select delete then you will remove this player and their data! Do you want to continue?"),
      actions: [
        TextButton(
            onPressed: () {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        floatingActionButton: FloatingActionButton(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const NewPlayerPage()));
            }),
        appBar: AppBar(
                ...
                if (snapshot.data != null && snapshot.data!.isNotEmpty) {
                      ...
                      itemBuilder: ((context, index) {
                        return Card(
                          child: ListTile(
                              ...
                              leading: Text(snapshot.data![index].number.toString(), style: const TextStyle(fontSize: 18)),
                  ...
                  return Center(
                    child: AlertDialog(
                      ...
                      content: const Text("There are no players available, try adding a new one!"),
                    ),
                  );
                }
              },
